...
export const emails = {
	...
	account: {
		deleted: "Your Dompetku account is Deleted!",
	},
	welcome: {
		subject: "✨ Welcome to Dompetku",
	},
	usageLimit: {
		premiumExpired: {
	...
	from: "Gokul from Dompetku <hello@dompetku>",
	signin: { subject: "Sign in link for Dompetku" },
	signup: { subject: "Sign up link for Dompetku" },
};
