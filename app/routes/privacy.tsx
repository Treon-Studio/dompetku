...
export default function Privacy() {
	...
	return (
		<I18nProvider locale={locale} translations={translations}>
			<div className="relative min-h-screen bg-linear-to-br from-sky-100 via-white to-sky-50 pl-2 pr-2 leading-relaxed text-zinc-800">
				...
				<div className="m-4 mt-4 max-w-3xl pt-3 sm:m-4 sm:mt-8 lg:m-auto">
					...
					<p className="mt-2">
						Author built the <b>Dompetku</b> web application as a <b>Freemium app</b>. This SERVICE is provided by at no
					...
					<p className="mt-2">
						...
						accessible at Dompetku unless otherwise defined in this Privacy Policy.
					</p>
				</div>
