...
export function getCloudflareEnv(context: unknown): CloudflareEnv {
	const ctx = context as { cloudflare?: { env?: CloudflareEnv } } | undefined;
	return ctx?.cloudflare?.env || ({} as CloudflareEnv);
}
